		...
		addCustomerPage.isertEmail("Raul");
		addCustomerPage.isertPhoneNumber("7202351245");
	    addCustomerPage.insertAddress("usa");
		addCustomerPage.insertCity("seattle");
	    addCustomerPage.insertState("washington");
	    addCustomerPage.insertZip("80236");
	    addCustomerPage.insertTag("business");
